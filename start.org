...
** Indentation
*** EditorConfig
    I'm trying out a new package called EditorConfig that keeps your
    indentation settings the same across editors. Unfortunately, it
    isn't available from standard Emacs package repos, so I have 
    vendored it.
