...
#+STYLE: <link rel="stylesheet" href="http://kevinburke.bitbucket.org/markdowncss/markdown.css" type="text/css"></link>
#+STYLE: <style type="text/css">pre.src { padding: 5pt; }</style>
